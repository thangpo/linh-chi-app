...
class _WishlistScreenState extends State<WishlistScreen> {
  static const String _wishlistUrl =
      'https://angelunigreen.com.vn/danh-sach-yeu-thich';
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (request) {
            // Cho phép điều hướng trong domain angelunigreen
            if (request.url.startsWith('https://angelunigreen.com.vn')) {
              return NavigationDecision.navigate;
            }
            // Chặn các domain khác (quảng cáo, tracker...)
            return NavigationDecision.prevent;
          },
        ),
      )
      ..loadRequest(Uri.parse(_wishlistUrl));
  }
